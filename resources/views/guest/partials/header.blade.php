        ...
        <div class="container-fluid ">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    ...
                    @if (Auth::check())
                        <form class="d-flex align-items-center mt-3" action="{{ route('logout') }}" method="POST" role="search">
                            @csrf
                    ...
                    @else
                        <form class="d-flex align-items-center mt-3" action="{{ route('login') }}" method="GET" role="search">
                            @csrf
